	...
	public String checkLogin()
	{
		...
		try{
			...
			if(sysUserList.size() == 0){
				...
				getLoginUser().setUserName("");
				FacesContext.getCurrentInstance().getExternalContext().redirect("http://localhost:8080/LocalMyCoursesProject/faces/PreProd/login.jsp");
				...
				FacesContext.getCurrentInstance().getExternalContext().redirect("http://localhost:8080/LocalMyCoursesProject/faces/PreProd/index.jsp");
