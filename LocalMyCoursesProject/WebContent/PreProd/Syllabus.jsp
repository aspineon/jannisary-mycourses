...
<title>Syllabus Administration</title>
            ...
            <h:panelGrid columns="1">
                <a4j:outputPanel ajaxRendered="true">
                    <h:panelGrid columns="2">
                        ...
                        <h:outputText value="Semester" />
                        <rich:comboBox id="selectSemesterIdForEdit" value="Select Semester" valueChangeListener="#{syllabusBean.selectionChangedSemesterCombo}" width="160px">
							<f:selectItems value="#{syllabusBean.semesterList}"/>
						</rich:comboBox>
                        
                        <h:outputText value="Year" />
                        <rich:comboBox id="selectYearIdForEdit" value="Select Year" valueChangeListener="#{syllabusBean.selectionChangedYearCombo}" width="160px">
