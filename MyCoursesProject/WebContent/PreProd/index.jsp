...
<h:inputHidden value="#{loginBean.isUser}" />
		...
		<rich:toolBar>
			<rich:dropDownMenu>
				...
				<rich:menuItem submitMode="none" >									
						<h:outputLink value="../PreProd/ManualScheduling.jsp" target="centerFrame">
	...
	<center><iframe style="background-image: url(../images/background10.jpg)" name="centerFrame" width="1330px" height="600px" align="middle"></iframe></center>
</f:view>
</body>
</html>