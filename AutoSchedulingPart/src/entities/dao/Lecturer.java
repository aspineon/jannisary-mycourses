...
//********************************************************************************
	...
	public ArrayList<Lecturer> getLecturerByCourseName(String courseName) {
		...
		try
		{
			...
			Query query = session.getNamedQuery("getLecturerByCourseName");
			query.setParameter("pCourseName", courseName);
			lecturerList = (ArrayList<Lecturer>)query.list();
		}
		catch(Exception ex)
		{
			ex.getMessage();
